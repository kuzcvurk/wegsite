...
{document.write('<object id="id3" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab" width="320" height="256" style="height: 256px; left: 190px; position: absolute; top: 30px; width: 320px; z-index: 1; "><param name="src" value="Media/voiceover_simple-10.mov" /><param name="controller" value="true" /><param name="autoplay" value="false" /><param name="scale" value="tofit" /><param name="volume" value="100" /><param name="loop" value="false" /></object>');}
else if(isiPhone)
{document.write('<object id="id3" type="video/quicktime" width="320" height="256" style="height: 256px; left: 190px; position: absolute; top: 30px; width: 320px; z-index: 1; "><param name="src" value="Voiceover_files/voiceover_simple-5.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/voiceover_simple-10.mov"/><param name="controller" value="true"/><param name="scale" value="tofit"/></object>');}
else
{document.write('<object id="id3" type="video/quicktime" width="320" height="256" data="Media/voiceover_simple-10.mov" style="height: 256px; left: 190px; position: absolute; top: 30px; width: 320px; z-index: 1; "><param name="src" value="Media/voiceover_simple-10.mov"/><param name="controller" value="true"/><param name="autoplay" value="false"/><param name="scale" value="tofit"/><param name="volume" value="100"/><param name="loop" value="false"/></object>');}}
